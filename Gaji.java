public class Gaji extends Pegawai { //Menggunakan extend untuk pewarisan Polymorphisme, jadi kelas Gaji merupakan superclass dari kelas Pegawai
    private double salary;  //Gaji Tahunan
    public Gaji(String name, String address, int number, double salary) {
        super(name, address, number);
        setSalary(salary);
    }
    public void mailCheck(){ //Terjadi overridding karena memiliki nama yang sama dengan method yang ada pada superclass(parents)
